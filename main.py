...
# Drop unnecessary columns of the inital dataset
def dataset_optimization(data):
    unnecessary_columns = ["cc_num", "first", "last", "gender", "job", "dob", "zip", "lat", "long", "merch_lat", "merch_long", "city_pop", "trans_num", "unix_time"]
